...
export class CategoryPage {
  ...
  itemTapped($event, item) {
    if(this.passedCategory=='VisitOneDay'){
       this.navCtrl.push(SingleItem2Page, item);
     }else if(this.passedCategory=='VisitGoEat'){
       this.navCtrl.push(SingleItem2Page, item);
     }
     else if(this.passedCategory=='VisitTempleTrip'){
       this.navCtrl.push(SingleItem2Page, item);
     }else{
    ...
    // window.open("https://www.google.co.th/maps/search/",'_system', 'location=yes');
